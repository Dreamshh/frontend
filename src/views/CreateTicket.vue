<template>
  <div class="add">
    <h2 class="display-1 font-weight-bold mb-3" style="text-align: center;">Оформить билет</h2>
    <br>
    <v-form
      @submit.prevent="TicketCreate"
      ref="buyForm"
      class="my-2"
    >
      <v-row>
    ...
    async TicketCreate() {
      try {
        const response = await this.axios
          .post('http://127.0.0.1:8000/tickets/create/', this.buyForm)
